...
void QueryTest::testSelection() {
    ...
    std::string sql_q1_caps = mSystem->convertToSQL(q1_caps);
...
void QueryTest::testMisc() {
    ...
    std::string sql_q2 = mSystem->convertToSQL(q2);
    std::string sql_q2_ = mSystem->convertToSQL(q2_);
    std::string _sql_q2 = mSystem->convertToSQL(_q2);
...
void QueryTest::testNested() {
    ...
    std::string sql_q4 = mSystem->convertToSQL(q4);
    ...
    std::string q5_exp = "";
    std::string sql_q5 = mSystem->convertToSQL(q5);
