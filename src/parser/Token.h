...
enum TokenTypes {
    // GRAMMATICA
    S, EXPRESSION, TABLE, MODIFICATION, PROJECTION, SELECTION, RENAME, EQUATION, RENAME_PREMISE, COLUMN_NAME, RENAME_SYMBOL, OPERATOR1, OPERATOR2, OPERATOR3, TABLE_NAME, VAR, DIGIT,
